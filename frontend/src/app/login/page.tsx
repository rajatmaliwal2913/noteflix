              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Email"
                    className="w-full pl-12 pr-4 py-4 bg-background border border-border rounded-xl text-foreground placeholder-foreground-muted focus:bg-card focus:ring-2 focus:ring-purple-500 outline-none"
                  />
